...
#define DP_VMODE			XVIDC_VM_1280x720_60_P
#define DP_BUFFERSIZE		VMODE_WIDTH * VMODE_HEIGHT * 3	/* HTotal * VTotal * BPP */
#define DP_LINESIZE			VMODE_WIDTH * 3			/* HTotal * BPP */
#endif
...
#define FRAME_VERT_LEN		VMODE_HEIGHT
#define SUBFRAME_START_OFFSET    (FRAME_HORI_LEN * 5 + 64)
#define DP_VMODE			XVIDC_VM_1920x1080_30_P
#define DP_BUFFERSIZE		VMODE_WIDTH * VMODE_HEIGHT * 3	/* HTotal * VTotal * BPP */
#define DP_LINESIZE			VMODE_WIDTH * 3			/* HTotal * BPP */
#endif
...
int main()
{
	...
	Status = DpdmaVideoExample(&RunCfg,&Intc,DP_VMODE,DP_LINESIZE,DP_BUFFERSIZE);
	if (Status != XST_SUCCESS) {
