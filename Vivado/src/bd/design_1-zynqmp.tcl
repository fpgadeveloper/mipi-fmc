...
dict set dp_dict pynqzu_pcam dpaux "MIO 27 .. 30"
dict set dp_dict pynqzu_pcam lane_sel "Dual Lower"
dict set dp_dict pynqzu_pcam ref_clk_freq "27"
dict set dp_dict pynqzu_pcam ref_clk_sel "Ref Clk1"
...
dict set dp_dict kv260_pcam dpaux "MIO 27 .. 30"
...
# Add the AXIS Switch to select between the potential two video outputs
if {$num_cams == 2} {
  ...
  connect_bd_intf_net [get_bd_intf_pins mipi_0/M_AXIS_MM2S] [get_bd_intf_pins axi4s_vid_out/video_in]
}
