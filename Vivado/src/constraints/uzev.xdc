...
set_property PACKAGE_PIN AD19 [get_ports iic_0_scl_io]; # LA05_P
set_property PACKAGE_PIN AE19 [get_ports iic_0_sda_io]; # LA05_N
...
set_property PACKAGE_PIN AF10 [get_ports iic_1_scl_io]; # LA19_P
set_property PACKAGE_PIN AG10 [get_ports iic_1_sda_io]; # LA19_N
...
# PIN_SWAP signal
set_property PACKAGE_PIN AG18 [get_ports {pin_swap[0]}]; # LA02_P
set_property IOSTANDARD LVCMOS12 [get_ports {pin_swap[0]}]

# GPIOs for MIPI camera 0
set_property PACKAGE_PIN AJ16 [get_ports {gpio_0_tri_o[0]}]; # LA08_P
set_property PACKAGE_PIN AK16 [get_ports {gpio_0_tri_o[1]}]; # LA08_N
set_property PACKAGE_PIN AA16 [get_ports {gpio_0_tri_o[2]}]; # LA07_P
set_property PACKAGE_PIN AB16 [get_ports {gpio_0_tri_o[3]}]; # LA07_N
set_property PACKAGE_PIN AH17 [get_ports {gpio_0_tri_o[4]}]; # LA04_P
set_property PACKAGE_PIN AJ17 [get_ports {gpio_0_tri_o[5]}]; # LA04_N
set_property PACKAGE_PIN AG16 [get_ports {gpio_0_tri_o[6]}]; # LA10_P
set_property PACKAGE_PIN AH16 [get_ports {gpio_0_tri_o[7]}]; # LA10_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_0_tri_o[*]}]

# GPIOs for MIPI camera 1
set_property PACKAGE_PIN AH9 [get_ports {gpio_1_tri_o[0]}]; # LA32_P
set_property PACKAGE_PIN AJ9 [get_ports {gpio_1_tri_o[1]}]; # LA32_N
set_property PACKAGE_PIN AJ2 [get_ports {gpio_1_tri_o[2]}]; # LA30_P
set_property PACKAGE_PIN AJ1 [get_ports {gpio_1_tri_o[3]}]; # LA30_N
set_property PACKAGE_PIN AF12 [get_ports {gpio_1_tri_o[4]}]; # LA22_P
set_property PACKAGE_PIN AF11 [get_ports {gpio_1_tri_o[5]}]; # LA22_N
set_property PACKAGE_PIN AK9 [get_ports {gpio_1_tri_o[6]}]; # LA26_P
set_property PACKAGE_PIN AK8 [get_ports {gpio_1_tri_o[7]}]; # LA26_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_1_tri_o[*]}]

# Reserved GPIOs
set_property PACKAGE_PIN AH18 [get_ports {rsvd_gpio_tri_o[0]}]; # LA02_N
set_property PACKAGE_PIN AE18 [get_ports {rsvd_gpio_tri_o[1]}]; # LA03_P
set_property PACKAGE_PIN AF18 [get_ports {rsvd_gpio_tri_o[2]}]; # LA03_N
...
set_property PACKAGE_PIN AJ14 [get_ports {mipi_phy_if_0_data_p[0]}]; # LA12_P
set_property PACKAGE_PIN AK14 [get_ports {mipi_phy_if_0_data_n[0]}]; # LA12_N
set_property PACKAGE_PIN AJ15 [get_ports {mipi_phy_if_0_data_p[1]}]; # LA13_P
set_property PACKAGE_PIN AK15 [get_ports {mipi_phy_if_0_data_n[1]}]; # LA13_N
set_property PACKAGE_PIN AF15 [get_ports {mipi_phy_if_0_data_p[2]}]; # LA14_P
set_property PACKAGE_PIN AG15 [get_ports {mipi_phy_if_0_data_n[2]}]; # LA14_N
set_property PACKAGE_PIN AK13 [get_ports {mipi_phy_if_0_data_p[3]}]; # LA15_P
set_property PACKAGE_PIN AK12 [get_ports {mipi_phy_if_0_data_n[3]}]; # LA15_N
