...
set_property PACKAGE_PIN AP38 [get_ports iic_0_scl_io]; # LA05_P
set_property PACKAGE_PIN AR38 [get_ports iic_0_sda_io]; # LA05_N
...
set_property PACKAGE_PIN N33 [get_ports iic_1_scl_io]; # LA19_P
set_property PACKAGE_PIN M33 [get_ports iic_1_sda_io]; # LA19_N
...
# PIN_SWAP signal
set_property PACKAGE_PIN AJ32 [get_ports {pin_swap[0]}]; # LA02_P
set_property IOSTANDARD LVCMOS12 [get_ports {pin_swap[0]}]

# GPIOs for MIPI camera 0
set_property PACKAGE_PIN AK29 [get_ports {gpio_0_tri_o[0]}]; # LA08_P
set_property PACKAGE_PIN AK30 [get_ports {gpio_0_tri_o[1]}]; # LA08_N
set_property PACKAGE_PIN AP36 [get_ports {gpio_0_tri_o[2]}]; # LA07_P
set_property PACKAGE_PIN AP37 [get_ports {gpio_0_tri_o[3]}]; # LA07_N
set_property PACKAGE_PIN AR37 [get_ports {gpio_0_tri_o[4]}]; # LA04_P
set_property PACKAGE_PIN AT37 [get_ports {gpio_0_tri_o[5]}]; # LA04_N
set_property PACKAGE_PIN AP35 [get_ports {gpio_0_tri_o[6]}]; # LA10_P
set_property PACKAGE_PIN AR35 [get_ports {gpio_0_tri_o[7]}]; # LA10_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_0_tri_o[*]}]

# GPIOs for MIPI camera 1
set_property PACKAGE_PIN L33 [get_ports {gpio_1_tri_o[0]}]; # LA32_P
set_property PACKAGE_PIN K33 [get_ports {gpio_1_tri_o[1]}]; # LA32_N
set_property PACKAGE_PIN N38 [get_ports {gpio_1_tri_o[2]}]; # LA30_P
set_property PACKAGE_PIN M38 [get_ports {gpio_1_tri_o[3]}]; # LA30_N
set_property PACKAGE_PIN N34 [get_ports {gpio_1_tri_o[4]}]; # LA22_P
set_property PACKAGE_PIN N35 [get_ports {gpio_1_tri_o[5]}]; # LA22_N
set_property PACKAGE_PIN V32 [get_ports {gpio_1_tri_o[6]}]; # LA26_P
set_property PACKAGE_PIN U33 [get_ports {gpio_1_tri_o[7]}]; # LA26_N
set_property IOSTANDARD LVCMOS12 [get_ports {gpio_1_tri_o[*]}]

# Reserved GPIOs
set_property PACKAGE_PIN AK32 [get_ports {rsvd_gpio_tri_o[0]}]; # LA02_N
set_property PACKAGE_PIN AT39 [get_ports {rsvd_gpio_tri_o[1]}]; # LA03_P
set_property PACKAGE_PIN AT40 [get_ports {rsvd_gpio_tri_o[2]}]; # LA03_N
...
set_property PACKAGE_PIN AH33 [get_ports {mipi_phy_if_0_data_p[0]}]; # LA12_P
set_property PACKAGE_PIN AH34 [get_ports {mipi_phy_if_0_data_n[0]}]; # LA12_N
set_property PACKAGE_PIN AJ35 [get_ports {mipi_phy_if_0_data_p[1]}]; # LA13_P
set_property PACKAGE_PIN AJ36 [get_ports {mipi_phy_if_0_data_n[1]}]; # LA13_N
set_property PACKAGE_PIN AG31 [get_ports {mipi_phy_if_0_data_p[2]}]; # LA14_P
set_property PACKAGE_PIN AH31 [get_ports {mipi_phy_if_0_data_n[2]}]; # LA14_N
set_property PACKAGE_PIN AG32 [get_ports {mipi_phy_if_0_data_p[3]}]; # LA15_P
set_property PACKAGE_PIN AG33 [get_ports {mipi_phy_if_0_data_n[3]}]; # LA15_N
